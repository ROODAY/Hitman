...
CreateConVar("ttt_detective_pct", "0.15", FCVAR_NOTIFY)
CreateConVar("ttt_detective_max", "32")
CreateConVar("ttt_detective_min_players", "7")
CreateConVar("ttt_detective_karma_min", "600")


-- Traitor credits
CreateConVar("ttt_credits_starting", "3")
...
-- Detective credits
CreateConVar("ttt_det_credits_starting", "0")
CreateConVar("ttt_det_credits_traitorkill", "0")
CreateConVar("ttt_det_credits_traitordead", "0")
...
function SelectRoles()
   ...
   hook.Add("TTTBeginRound", "DetectiveRemove", function() --Added VV
	for k,v in pairs(player.GetAll()) do 
