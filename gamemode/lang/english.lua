...
L.body_found_d     = "He was a Jihadist."
L.body_found_i     = "He was a Civilian."

L.body_confirm     = "{finder} confirmed the death of {victim}."

L.body_call        = "{player} called a Detective to the body of {victim}! Sucks that there are none!"
...
L.search_eyes   = "Using your ninja jihadist skills, you identified the last person he saw: {player}. The killer, or a coincidence?"
...
L.item_radar      = "Radar"
L.item_radar_desc = [[
SHOWS YOUR NEXT TARGET! BUY RIGHT AWAY!!
...
Be careful of Jihadists! They don't care who they kill, so watch out!
Watch your back and work with your comrades to get out of this alive!]]

L.info_popup_detective = [[You are a Jihadist! Terrorist HQ has given you special resources to blow up everyone.
Use your jihad bomb to take out as many as you can!
Keep an eye out for hitmen and try to get them too
MAKE SURE you turn on your disguiser!!
Pull out your bomb, use the disguise and alalala!

If you find credits, you can become even better at being hidden!]]

L.info_popup_traitor_alone = [[You are a HITMAN! You have no fellow hitmen this round.

Kill all others (in the right order) to win!
If you kill out of order YOU WILL BE REVEALED!

Press {menukey} to receive your special equipment!]]

L.info_popup_traitor = [[You are a HITMAN! Work with fellow hitmen to kill all others.
But take care, killing the wrong people will cost you...
Failure to kill the target will result in a reveal
...
L.tip3 = "Jihadists have no team. Kill as many people as you can, but you only get 1 shot. If you find traitor bodies, you can get credits to improve your effectiveness."

L.tip4 = "No one will know you have died until they find your dead body and identify you by searching it."

L.tip5 = "When a Hitman kills a Jihadist, he instantly receives a credit reward."

L.tip6 = "When a Hitman dies, Jihadists can pick up credits from the body. These can buy disguisers and radar to improve stealth."
...
L.tip8 = "Hitmen and Jihadists can collect unspent equipment credits from the dead bodies of other Hitmen."

L.tip9 = "All players should watch the chat popups for information about which Hitmen have killed out of order. These will have green text with a RED name."

L.tip10 = "As Hitman or Jihadist, keep an eye on red messages in the top right. These will be important for you."

L.tip11 = "As Hitman, keep in mind you are rewarded extra equipment credits if you and your comrades perform well. Make sure you remember to spend them!"

L.tip12 = "Since there are no detectives, there is no way to get health back. Be careful not to fall too often, or you could be blown up easier by a wayward Jihadist."

L.tip13 = "As a Hitman, since your targets are more difficult to find, use the RADAR to track them down (it will focus only on your target). Hide bodies as best as you can so people won't suspect you."

L.tip14 = "The further you are away from someone you kill, the less likely it is that people will see you do it. Be careful not to be too obviously seperate from everyone else."
...
L.tip19 = "Since Jihadists are frequently around, be sure to stay spread out at least until the Jihadists detonate. This will give them less targets to hit."

L.tip20 = "Jihadists will not know who the other Jihadists are, so as a Jihadist, try to stay away from big groups until you want to Jihad. This will keep you from being an accidental target."

L.tip21 =  "Since this is a custom gamemode, make sure you read the !motd to get filled in on any new changes."

L.tip22 = "Hitmen will have a difficult time killing people in groups. Be sure to stay away from those groups so that if a Jihadist is in there, you won't die too. Use the radar to track your target at range."

L.tip23 = "There are no Detectives, so DNA left on bodies is much less detrimental. However, Jihadists can still find the 'Last Seen' person, so try to be stealthy, or they might come after you."

L.tip24 = "Press {helpkey} to view a short tutorial or modify some TTT-specific settings. For example, you can permanently disable these tips there. These will help with basic gamemode principles, but aren't totally relevant."

L.tip25 = "When a Jihadist searches a body, the result is available to all players via the scoreboard by clicking on the name of the dead person."

L.tip26 = "In the scoreboard, a magnifying glass icon next to someone's name indicates you have search information about that person. If the icon is bright, the data comes from a Jihadist and may contain additional information."

L.tip27 = "As Jihadist, corpses with a magnifying glass after the nickname have been searched by a Jihadist and their results are available to all players via the scoreboard."
...
L.tip35 = "As Hitman, remember you can carry dead bodies and hide them from the prying eyes of civilians and Jihadists."
...
--- v23
L.set_avoid_det     = "Avoid being selected as Jihadist"
L.set_avoid_det_tip = "Enable this to ask the server not to select you as Jihadist if possible. Does not mean you are Hitman more often."
